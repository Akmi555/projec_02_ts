...
//1. Создаём независимое хранилище - контекст, 
// с помощью функции React createContext
...
function MainCard() {
  ...
  return (
    //2. Создаём обертку, которая позволит получить значение 
    // из контекста в любом компоненте, который будет вложенным в обертку
